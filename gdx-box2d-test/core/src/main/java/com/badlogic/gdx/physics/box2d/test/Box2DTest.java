...
public abstract class Box2DTest implements ApplicationListener, InputProcessor {
	...
	public boolean touchDown (int x, int y, int pointer, int button) {
		...
		if (hitBody != null) {
			...
			Joint.StiffnessAndDamping stiffnessAndDamping = Joint.linearStiffness(4.0f, 0.7f, groundBody, hitBody);
			def.stiffness = stiffnessAndDamping.stiffness;
			def.damping = stiffnessAndDamping.damping;
