...
import com.badlogic.gdx.box2dLight.*;
...
public class Box2dLightTest extends InputAdapter implements ApplicationListener {
  ...
  @Override public void render() {
    ...
    batch.begin();
    {
      ...
      for (int i = 0; i < BALLSNUM; i++) {
        ...
        batch.draw(textureRegion, position.x - RADIUS, position.y - RADIUS, RADIUS, RADIUS, RADIUS * 2, RADIUS * 2, 1f, 1f, angle);
      }
    }
    batch.end();
  ...
  private void createPhysicsWorld() {
    ...
    chainShape.createLoop(new Vector2[]{new Vector2(-halfWidth, 0f), new Vector2(halfWidth, 0f), new Vector2(halfWidth, viewportHeight), new Vector2(-halfWidth, viewportHeight)});
