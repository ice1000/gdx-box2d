...
b2ContactFilter defaultFilter;
  ...
  public void setContactFilter(ContactFilter filter) {
    ...
    setUseDefaultContactFilter(addr, filter == null);
  }
...
//    if (useDefault) {
//      world->SetUseContactFilter();
//    } else {
//      CustomContactFilter contactFilter(env, object);
//      world->SetContactFilter(&contactFilter);
//    }
    // FIXME (ice1000: I'm so confused)
	*/
  ...
  private long createProperJoint(JointDef def) {
    ...
    if (def.type == JointType.WheelJoint) {
      ...
      return jniCreateWheelJoint(addr, d.bodyA.addr, d.bodyB.addr, d.collideConnected, d.localAnchorA.x, d.localAnchorA.y,
          d.localAnchorB.x, d.localAnchorB.y, d.localAxisA.x, d.localAxisA.y, d.enableLimit, d.lowerTranslation, d.upperTranslation,
          d.enableMotor, d.maxMotorTorque, d.motorSpeed, d.stiffness, d.damping);
    }
